...
public class NotificationDAO {
	public List<Meeting> selectMyfuturemeet(int empid,String nowdate,String nextdate){
		...
		String sql = "select meeting.meetingid, meeting.meetingname, " +
				...
				"and meeting.reservationistid="+empid+" and meeting.starttime>" +
				"to_date('"+nowdate+"','yyyy-mm-dd') " +
				"and meeting.endtime<to_date('"+nextdate+"','yyyy-mm-dd')";
