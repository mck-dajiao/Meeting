...
public class SelectMeetingServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public SelectMeetingServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(methodCode.equals("selectmeet")){
		MeetingRoomService sec=new MeetingRoomService();
		List list=sec.findRoom();
       // SelectMeetingroomDAO room=new SelectMeetingroomDAO();
        //List list=room.looking();
