...
<frameset rows="150,*,93" cols="*" framespacing="0" frameborder="no" border="0">
 ...
 <frameset cols="260,*" id="frame">
	...
	<frame src="03.html" name="main" marginwidth="50px" marginheight="40px" frameborder="0" scrolling="auto" target="_self"  />
    </frameset>
 <frame src="04.html" name="bottomFrame" scrolling="No" noresize="noresize" id="bottomFrame" marginwidth="0" marginheight="0"/>
