...
import com.soft.meetmanager.service.AdddepartmentService;
...
public class DepartmentServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		departname.setDepartmentname(departmentname);
		AdddepartmentService ser=new AdddepartmentService();
		ser.addd(departname);
		//AdddepartmentDAO adp=new AdddepartmentDAO();
		//adp.insert(departname);
