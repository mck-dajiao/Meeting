...
public class BookMeetingServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		MeetingRoomService mrService = new MeetingRoomService();
		List<MeetingRoom> mtromList = new ArrayList<MeetingRoom>();
		mtromList = mrService.findmetRoom();
		request.setAttribute("roomlist", mtromList);
