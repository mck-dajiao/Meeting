            ...
            <div class="page-sidebar">
                <div class="sidebar-menugroup">
                    ...
                    <ul class="sidebar-menu">
                        <li class="sidebar-menuitem"><a href="NotificationsServlet?empid=<%=emp.getEmployeeid() %>" target="main">最新通知</a></li>
                        <li class="sidebar-menuitem active"><a href="MybookingServlet?empid=<%=emp.getEmployeeid() %>" target="main">我的预定</a></li>
                        <li class="sidebar-menuitem"><a href="MymeetingServlet?empid=<%=emp.getEmployeeid() %>" target="main" >我的会议</a></li>
                    </ul>
                </div>
                ...
                <div class="sidebar-menugroup">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-menuitem"><a href="LookingForServlet" target="main">注册审批</a></li>
