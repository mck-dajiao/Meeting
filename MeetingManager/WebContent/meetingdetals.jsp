<%@ page language="java" import="com.soft.meetmanager.model.Meeting" import="java.util.*" pageEncoding="utf-8"%>
<%
String path = request.getContextPath();
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
%>
 <%Meeting mt = (Meeting)request.getAttribute("mtdetail"); %>
<!DOCTYPE html>
<html>
    <head>
                ...
                <form>
                    <fieldset>
                        ...
                        <table class="formtable">
                            ...
                            <tr>
                                <td>预计参加人数：</td>
                                <td><%=mt.getNumberofparticipants() %></td>
                            </tr>
                            <tr>
                                <td>预计开始时间：</td>
                                <td><%=mt.getStarttime() %></td>
                            </tr>
                            <tr>
                                <td>预计结束时间：</td>
                                <td><%=mt.getEndtime() %>
                            ...
                            <tr>
                                <td>会议说明：</td>
                                <td>
                                    <textarea id="description" rows="5" readonly><%=mt.getDescription() %></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>参会人员：</td>
