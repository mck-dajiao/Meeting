                    ...
                    <fieldset>
                        ...
                        <table class="formtable">
                            <tr>
                                <td>门牌号:</td>
                                <td>
                                    <input id="roomnumber" type="text" name="roomnumber" placeholder="例如：201" maxlength="10"/>
                                </td>
                            </tr>
                            <tr>
                                <td>会议室名称:</td>
                            ...
                            <tr>
                                <td>备注：</td>
                                <td>
                                    <textarea id="description" maxlength="200" name="description" rows="5" cols="60" placeholder="200字以内的文字描述"></textarea>
                                </td>
                            </tr>
                            <tr>
